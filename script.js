(() => {
  ...
  const GUIDE_BANNER = {
    ...
    body:
      ...
      // 이용료는 본문에서 '붙을 수 있어요 / 지점에 따라 다를 수 있어요'로 푼다.
      '<p>탕을 골랐다면, 소스바를 이용할 인원수도 함께 선택해요. 소스바는 이용 인원수에 따라 이용료가 붙을 수 있어요. ' +
      '금액과 기준은 지점에 따라 다를 수 있으니, 주문할 때 태블릿 화면의 안내를 확인해주세요.</p>' +
