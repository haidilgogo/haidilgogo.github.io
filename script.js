(() => {
  ...
  const RECIPES = [
    ...
    { id: 's33', date: '2025-09-24', cat: '소스', emoji: '🥣', img: 'assets/cards/킹키소스(후각).jpg', imgFit: 'cover', tint: 'linear-gradient(160deg,#EDEFF3,#CBD2DC)', name: '킹키소스', ver: '후각', source: 'YouTube 권또또 KWONTTOTTO', person: '킹키', desc: '유튜브 <b>또렌드대탐험</b> 촬영 중 <b>킹키</b>가 소스바 재료들의 냄새를 맡아 가며 만든 소스로, <u>코로 만든 소스</u>라고 했다.',
      ...
      steps: [],
      tip: '' },
    { id: 's34', date: '2025-07-29', cat: '소스', emoji: '🥣', img: 'assets/cards/사인클소스.jpg', imgFit: 'cover', tint: 'linear-gradient(160deg,#6B7799,#4A5470)', name: '사인클소스', source: 'X @gimsyabeu', person: '사회인 게임클럽', desc: '유튜버 <b>사회인 게임클럽</b>의 횐이인 <b>김샤브</b>가 추천하는 소스로, X에서 명성이 자자하다.',
      ings: [['간장소스', '1.5', '국자'], ['스위트칠리소스', '1', '국자'], ['굴소스', '1', '스푼'], ['고추기름', '1', '스푼'], ['다진 파', '1', '스푼'], ['다진 마늘', '1', '스푼'], ['땅콩가루', '1', '스푼'], ['고수', '', '적당히'], ['태국고추', '', '적당히']],
      steps: [],
      tip: '간장이 짤 경우 반국자 정도만 넣기' },
    { id: 's35', date: '2025-07-29', cat: '소스', emoji: '🥣', img: 'assets/cards/사인클양파소스.jpg', imgFit: 'cover', tint: 'linear-gradient(160deg,#3A3A3A,#111111)', name: '사인클양파소스', source: 'X @gimsyabeu', person: '사회인 게임클럽', desc: '유튜버 <b>사회인 게임클럽</b>의 횐이인 <b>김샤브</b>가 추천하는 <b>사인클소스</b>에 양파를 가득 넣은 버전이다.',
      ings: [['간장소스', '2', '국자'], ['스위트칠리소스', '1', '국자'], ['양파', '', '넉넉하게'], ['고추기름', '1', '스푼'], ['다진 파', '1', '스푼'], ['다진 마늘', '1', '스푼'], ['굴소스', '1', '스푼'], ['땅콩가루', '1', '스푼'], ['고수', '', '적당히'], ['태국고추', '', '적당히']],
      steps: [],
      tip: '간장이 짤 경우 반국자 정도만 넣기' },
