(() => {
  ...
  const RECIPES = [
    ...
    { id: 's5', cat: '소스', emoji: '🥣', img: 'assets/recipe card_영지소스.jpg', imgFit: 'cover', imgPosition: 'right 12%', tint: 'linear-gradient(160deg,#F5E6D3,#E8C9A0)', name: '영지소스', source: 'YouTube 채널십오야', desc: '유튜브 채널 \'채널십오야\'의 나영석의 보글보글 촬영 중 \'이영지\'가 공개한 소스이다.',
      ...
      steps: [],
      tip: '' },
    { id: 'r1', cat: '밥', emoji: '🍚', img: 'assets/recipe card_메기살덮밥.png', imgFit: 'cover', tint: 'linear-gradient(160deg,#FFF6DC,#FCE4AE)', name: '메기살덮밥', source: 'X @dduuuu__', desc: 'X에 \'#초콜렛밥\'이라는 해시태그를 걸고 @dduuuu__가 공개한 덮밥으로 마라훠궈 국물에 익힌 메기살을 특제소스에 비빈 밥에 얹어 먹는 히든 메뉴이다.',
