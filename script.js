(() => {
  ...
  const RECIPES = [
    ...
    { id: 's5', date: '2025-04-11', cat: '소스', emoji: '🥣', img: 'assets/recipe card_영지소스.jpg', imgFit: 'cover', imgPosition: 'right 12%', tint: 'linear-gradient(160deg,#F5E6D3,#E8C9A0)', name: '영지소스', source: 'YouTube 채널십오야', desc: '유튜브 채널 \'채널십오야\'의 나영석의 보글보글 촬영 중 \'이영지\'가 공개한 소스이다.',
      ...
      steps: [],
      tip: '' },
    { id: 's7', date: '2025-04-11', cat: '소스', emoji: '🥣', tint: 'linear-gradient(160deg,#FDEBD0,#F5C99B)', name: '마크소스', source: 'YouTube 채널십오야', desc: '유튜브 채널 \'채널십오야\'의 나영석의 보글보글 촬영 중 \'마크\'가 공개한 소스이다.',
      ings: [['땅콩참깨소스', '2', '스푼'], ['다진마늘', '1.5', '스푼'], ['다진양파', '1.5', '스푼'], ['굴소스', '1', '스푼'], ['태국고추', '1', '스푼'], ['간장소스', '2', '스푼'], ['오향우육(다진고기)', '', '적당히'], ['다진파', '', '적당히'], ['땅콩가루', '', '적당히'], ['마라시즈닝(고춧가루)', '', '적당히']],
      steps: [],
      tip: '' },
    { id: 's14', date: '2026-05-18', cat: '소스', emoji: '🥣', tint: 'linear-gradient(160deg,#EAF3D8,#C9DFA0)', name: '라젤소스', source: 'YouTube 라젤Razel', desc: '유튜브 채널 \'라젤Razel\'에서 라젤이 좋아한다며 공개한 간장 베이스 소스이다.',
      ings: [['다진양파', '', '넉넉하게'], ['간장소스', '2', '스푼'], ['다진마늘', '1', '스푼'], ['다진파', '1', '스푼'], ['고추기름', '1', '스푼'], ['마라시즈닝(고춧가루)', '1', '스푼'], ['중국식초', '1', '스푼'], ['참기름', '0.5', '스푼'], ['태국고추', '', '넉넉하게']],
      steps: [],
      tip: '' },
    { id: 's15', date: '2026-05-18', cat: '소스', emoji: '🥣', tint: 'linear-gradient(160deg,#F3E8D6,#DCC39E)', name: '아는 동생 소스', source: 'YouTube 라젤Razel', desc: '유튜브 채널 \'라젤Razel\'에서 라젤이 \'아는 동생이 이렇게 먹는다\'며 소개한 소스이다.',
