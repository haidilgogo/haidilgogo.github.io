(() => {
  ...
  const RECIPES = [
    ...
    { id: 's14', date: '2026-05-18', cat: '소스', emoji: '🥣', img: 'assets/recipe card_라젤소스.jpg', imgFit: 'cover', tint: 'linear-gradient(160deg,#EAF3D8,#C9DFA0)', name: '라젤소스', source: 'YouTube 라젤Razel', desc: '유튜브 채널 \'라젤Razel\'에서 라젤이 좋아한다며 공개한 간장 베이스 소스이다.',
      ...
      steps: [],
      tip: '' },
    { id: 's15', date: '2026-05-18', cat: '소스', emoji: '🥣', img: 'assets/recipe card_라젤아는동생소스.jpg', imgFit: 'cover', tint: 'linear-gradient(160deg,#F3E8D6,#DCC39E)', name: '라젤 아는동생소스', source: 'YouTube 라젤Razel', desc: '유튜브 채널 \'라젤Razel\'에서 라젤이 \'아는 동생이 이렇게 먹는다\'며 소개한 소스이다.',
