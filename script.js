(() => {
  ...
  const GUIDE_BANNER = {
    ...
    body:
      ...
      //    (1) 그릇을 소스바에서 직접 챙기는지 — 전경 그림 하단 진열장에 그릇이 보여서 그렇게 썼다.
      //        자리에 미리 놓여 있는 거라면 '그릇을 하나 챙기고' 문장을 고쳐야 한다.
      //    (2) 소스바를 몇 번이든 다시 갈 수 있는지 — 팁 박스가 왕복이 자유롭다는 전제로 쓰였다.
      ...
      '<p>셀프소스바에는 땅콩참깨소스·사차장 같은 베이스 소스부터 다진 마늘·고수 같은 향신 재료, 땅콩가루와 고추기름까지 다양한 재료가 놓여 있어요.</p>' +
      '<p>그릇을 하나 챙기고 원하는 재료를 원하는 만큼 담으면, 그게 바로 나만의 소스예요.</p>' +
      '<h3>하딜고고를 열고 레시피대로 담아요</h3>' +
      ...
      // 추천·조언은 소제목이 아니라 팁 박스로(STEP 1과 같은 규칙).
      '<div class="col-tip">' +
        '<img class="col-tip-ic" src="assets/icons/bulb.png?v=1" alt="" width="18" height="18" draggable="false">' +
        '<div class="col-tip-body">' +
          '<b class="col-tip-title">한 번에 완성하지 않아도 괜찮아요</b>' +
          '<p>처음엔 조금만 만들어 맛보고, 입에 맞게 재료를 더해보세요.</p>' +
        '</div>' +
      '</div>',
  };
