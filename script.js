(() => {
  ...
  const RECIPES = [
    ...
    { id: 's31', date: '2025-09-24', cat: '소스', emoji: '🥣', img: 'assets/cards/또또소스.jpg', imgFit: 'cover', tint: 'linear-gradient(160deg,#F8E6DA,#EFC8B0)', name: '또또소스', source: 'YouTube 권또또 KWONTTOTTO', person: '또또', desc: '유튜브 <b>또렌드대탐험</b> 촬영 중 <b>권또또</b>가 다른 손님에게 도움을 받아 만든 소스로, 맛을 보더니 자기 소스는 망한 것 같다며 <u>따라 먹지 마요 본인이 하고 싶은 대로 드세요</u>라고 했다.',
      ...
      steps: [],
      tip: '' },
    { id: 's32', date: '2025-09-24', cat: '소스', emoji: '🥣', img: 'assets/cards/킹키소스(땅콩참깨).jpg', imgFit: 'cover', tint: 'linear-gradient(160deg,#E7EDF7,#C6D3E8)', name: '킹키소스', ver: '땅콩참깨', source: 'YouTube 권또또 KWONTTOTTO', person: '킹키', desc: '유튜브 <b>또렌드대탐험</b> 촬영 중 <b>킹키</b>가 하이디라오가 난생처음이라며 소스를 만들고 있던 손님에게 도움을 받아 만든 소스로, 맛을 보더니 <u>단맛 들어간 땅콩버터가 사실 맛있잖아요</u>라며 설탕을 왕창 넣은 버전으로 확정했다.',
      ings: [['땅콩참깨소스', '1', '스푼'], ['참깨', '1', '스푼'], ['다진 파', '1', '스푼'], ['스위트칠리소스', '1', '스푼'], ['고추기름', '0.5', '스푼'], ['다진 마늘', '1', '스푼'], ['양파', '1', '스푼'], ['땅콩가루', '1', '스푼'], ['와사비', '', '조금'], ['설탕', '', '넉넉하게']],
      steps: [],
      tip: '' },
    { id: 's33', date: '2025-09-24', cat: '소스', emoji: '🥣', img: 'assets/cards/킹키소스(후각).jpg', imgFit: 'cover', tint: 'linear-gradient(160deg,#EDEFF3,#CBD2DC)', name: '킹키소스', ver: '후각', source: 'YouTube 권또또 KWONTTOTTO', person: '킹키', desc: '유튜브 <b>또렌드대탐험</b> 촬영 중 <b>킹키</b>가 소스바 재료들의 냄새를 맡아 가며 만든 소스로, <u>코로 만든 소스</u>라고 했다.',
