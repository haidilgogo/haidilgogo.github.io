(() => {
  ...
  const RECIPES = [
    ...
    { id: 'b5', cat: '육수', emoji: '🍲', img: 'assets/cards/마라훠궈탕.jpg?v=1', imgFit: 'cover', tint: 'linear-gradient(160deg,#F2DDD3,#D9A48F)', name: '마라훠궈탕', source: 'Gemini AI', desc: '맑은 탕에 소스바 재료를 넣어서 셀프로 만드는 마라훠궈탕이다.',
      ...
      tip: '' },
    { id: 'b6', cat: '육수', emoji: '🍲', img: 'assets/cards/혼자햐탕.jpg?v=1', imgFit: 'cover', tint: 'linear-gradient(160deg,#F2DDD3,#D9A48F)', name: '혼자햐탕', source: 'YouTube 혼자햐', desc: '유튜버 <b>혼자햐</b>가 하이디라오에 혼자 가서 만든 마라탕으로, 맑은 탕에 소스바 재료를 넣어서 셀프로 만드는 마라훠궈 육수이다.',
      order: [['맑은 탕/물', '', '']],
