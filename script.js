(() => {
  ...
  const GUIDE_BANNER = {
    ...
    body:
      ...
      // '너무 익어버려요'만 있을 때보다 설득이 세다. BONUS의 거름망 팁("탕 안에서 찾기 어려운
      // 재료를 거름망에 넣으면 건져 먹기 편하다")과도 이어진다 — 여기서 '찾기 어렵다'를 깔아둔다.
      ...
      // 🔴 초안의 '조리법이 헷갈리면 직원에게 편하게 물어보세요'는 뺐다(2026-07-29 사용자 지적).
      //   직원이 익는 시간을 알려주는지는 확인된 사실이 아니다. 이 팁에서 정말 중요한 건
      //   '충분히 익혀 드세요'(안전)이지 직원 안내가 아니라서, 직원 얘기를 빼도 핵심은 그대로 남는다.
      //   직원 관련 내용은 BONUS에 모은다(거름망 팁도 거기서 hedge를 문장에 녹이기로 함).
      '<div class="col-tip">' +
        '<img class="col-tip-ic" src="assets/icons/bulb.png?v=1" alt="" width="18" height="18" draggable="false">' +
        '<div class="col-tip-body">' +
          '<b class="col-tip-title">고기와 해산물은 충분히 익혀 드세요</b>' +
          '<p>재료마다 익는 시간이 달라요. 특히 고기와 해산물은 속까지 충분히 익은 뒤에 드시는 게 좋아요.</p>' +
        '</div>' +
      '</div>',
  };
