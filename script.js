(() => {
  ...
  const BASE_LIKES = {
    // 소스 — 표시: 38 24 22 20 18 17 15 14 12 11 / 10 10 9 8 7 6 6 5 4 3
    s1: 32,   // 1위  건희소스 오리지널 · 2021   (표시 38 = 더미 32 + 실제 6)
    s2: 23,   // 2위  쑨디2호소스 2022          (표시 24 = 더미 23 + 실제 1)
    s5: 22,   // 3위  영지소스 2025
    s19: 18,  // 4위  박은영소스 참기름          (표시 20 = 더미 18 + 실제 2)
    s21: 18,  // 5위  장하오소스
    s16: 17,  // 6위  건희소스 짭짤 · 2021
    s7: 15,   // 7위  마크소스
    s23: 14,  // 8위  영지소스 악마 · 2023
    s18: 12,  // 9위  세훈소스 마장
    s4: 6,    // 10위 화령소스                 (표시 11 = 더미 6 + 실제 5)
    s26: 10,  // 11위 건희소스 2024        ┐ 동점 10 — 건희 2024가 더 최신이라 앞에 온다
    s3: 10,   // 12위 쑨디2호소스 2024     ┘
    s22: 9,   // 13위 수코소스
    s17: 8,   // 14위 세훈소스 간장
    s24: 7,   // 15위 김풍소스
    s20: 6,   // 16위 박은영소스 마장      ┐ 동점 6 — 박은영 마장이 더 최신이라 앞에 온다
    s14: 6,   // 17위 라젤소스             ┘
    s25: 5,   // 18위 우기소스
    s27: 4,   // 19위 건희소스 리뉴얼 · 2025
    s15: 3,   // 20위 라젤(이 아는 동생)소스
    // 탕 — 홈 탕 카드엔 하트가 없어 숫자는 안 보이고 순서만 정한다(전체보기·상세에선 보인다)
    b6: 5,    // 1위 혼자햐탕
    b4: 4,    // 2위 토마토탕
    b7: 2,    // 3위 지새기탕              (표시 3 = 더미 2 + 실제 1)
    b3: 2,    // 4위 스키야키탕
    b5: 1,    // 5위 마라훠궈탕
    // 히든메뉴 — 탕보다 높게 잡았다(사용자 지정)
    e1: 12,   // 1위 유부 새우완자
    r1: 8,    // 2위 메기살덮밥             (표시 11 = 더미 8 + 실제 3)
    r3: 10,   // 3위 희수국밥
    n1: 9,    // 4위 토마토에그누들
    e3: 8,    // 5위 유부 새우완자 업그레이드
    r2: 7,    // 6위 토마토달걀밥
    e2: 6,    // 7위 토마토달걀만두
    n2: 5     // 8위 탄탄면
  };
