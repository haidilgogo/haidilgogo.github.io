(() => {
  ...
  const RECIPES = [
    ...
    { id: 's32', date: '2025-09-24', cat: '소스', emoji: '🥣', img: 'assets/cards/킹키소스.jpg', imgFit: 'cover', tint: 'linear-gradient(160deg,#E7EDF7,#C6D3E8)', name: '킹키소스', source: 'YouTube 권또또 KWONTTOTTO', person: '킹키', desc: '유튜브 <b>또렌드대탐험</b> 촬영 중 <b>킹키</b>가 하이디라오가 난생처음이라며 소스를 만들고 있던 손님에게 도움을 받아 만든 소스로, 맛을 보더니 <u>단맛 들어간 땅콩버터가 사실 맛있잖아요</u>라며 설탕을 왕창 넣은 버전으로 확정했다.',
      ...
      steps: [],
      tip: '' },
    { id: 's33', date: '2025-09-24', cat: '소스', emoji: '🥣', img: 'assets/cards/킹키가 후각으로 만든소스.jpg', imgFit: 'cover', tint: 'linear-gradient(160deg,#EDEFF3,#CBD2DC)', name: '킹키가 후각으로 만든소스', nameHtml: '킹키<span class="name-sub">가 후각으로 만든</span>소스', source: 'YouTube 권또또 KWONTTOTTO', person: '킹키', desc: '유튜브 <b>또렌드대탐험</b> 촬영 중 <b>킹키</b>가 소스바 재료들의 냄새를 맡아 가며 만든 소스로, <u>코로 만든 소스</u>라고 했다.',
