  ...
  */
  ...
  const RECIPES = [
    ...
    { id: 'b3', cat: '탕', emoji: '🍲', img: 'assets/cards/스키야키탕.jpg?v=2', imgFit: 'cover', tint: 'linear-gradient(160deg,#F3E3CC,#E0C298)', name: '스키야키탕', desc: '맑은 탕에 소스바 재료를 넣어서 셀프로 만드는 스키야키탕이다.',
      order: [['맑은 탕/맹물', '', '']],
      ings: [['굴소스', '3', '스푼'], ['완자간장소스', '1', '그릇'], ['오향우육', '2', '스푼'], ['다진 마늘', '0.5', '스푼'], ['다진 파', '0.5', '그릇'], ['설탕', '2', '스푼'], ['소금', '3', '스푼']],
      steps: [
    ...
    { id: 'b6', date: '2025-02-05', cat: '탕', emoji: '🍲', img: 'assets/cards/혼자햐탕.jpg?v=1', imgFit: 'cover', tint: 'linear-gradient(160deg,#F2DDD3,#D9A48F)', name: '혼자햐탕', source: 'YouTube 혼자햐', desc: '유튜버 <b>혼자햐</b>가 혼자 하이디라오에 가서 맑은 탕에 소스바 재료를 넣어서 셀프로 만드는 마라탕이다.',
      order: [['맑은 탕/맹물', '', '']],
      ings: [['땅콩참깨소스', '6', '스푼'], ['참기름', '3', '스푼'], ['산초기름(화조유)', '3', '스푼'], ['고추기름', '3', '스푼'], ['청유훠궈소스', '3', '스푼'], ['다진 마늘', '3', '스푼'], ['굴소스', '3', '스푼'], ['완자간장소스', '3', '스푼'], ['참깨', '', '적당히'], ['소금', '', '적당히']],
      steps: [
        '소스바에서 가져온 재료를 물이 끓으면 넣고 계속 끓여준다',
      ],
    ...
    { id: 'b7', date: '2026-06-10', cat: '탕', emoji: '🍲', img: 'assets/cards/지새기탕.jpg?v=1', imgFit: 'cover', tint: 'linear-gradient(160deg,#FBEBD0,#EFCB94)', name: '지새기탕', source: 'YouTube 지새기의 인간극장', desc: '유튜버 <b>지새기</b>가 마라탕을 셀프로 만들기 위해 레시피를 미리 공부까지 해갔으나, 정작 소스바 앞에서 본인 마음대로 조합하다가 맛이 애매해졌다. 이를 가엽게 여긴 <s>천사가</s> 직원이 나타나 만들어준 비법 레시피이다.',
      order: [['맑은 탕/맹물', '', '']],
      ings: [['땅콩참깨소스', '1', '그릇'], ['땅콩참깨소스', '1', '스푼'], ['산초기름(화조유)', '6', '스푼'], ['소금', '2', '스푼'], ['설탕', '6', '스푼'], ['굴소스', '1', '스푼'], ['마라시즈닝(고춧가루)', '1', '스푼'], ['완자간장소스', '1', '스푼'], ['참기름', '1', '스푼'], ['태국고추', '1', '스푼'], ['다진 마늘', '1', '스푼'], ['매운소고기소스', '1', '스푼'], ['청유훠궈소스', '1', '스푼']],
      steps: [
        '직원분께 맑은 탕 물의 절반을 빼 달라고 요청한다',
        '소스바에서 가져온 재료를 물이 끓으면 넣고 계속 끓여준다',
      ],
  ...
  function renderIngList(el, items) {
    ...
    items.forEach((i, idx) => {
      ...
      /* 🔴 소스바에 없는 이름(내 소스의 「기타」 직접 입력)은 **공통 그림 `_직접입력.webp`** — 빈 종지에 숟가락에서 방울이 떨어지는 그림(2026-09-02 사용자님 확정).
         「넣는 중」이라는 뜻이라 직접 추가한 재료에 맞다. 파일 없는 소스바 재료(사진 대기 7)는 그대로 빈자리 — 「곧 온다」와 「원래 없다」를 갈라 둔다. */
      const 그림 = 이름반복 ? ''
        : (SAUCE_BAR.indexOf(i[0]) >= 0
          ? '<img src="assets/sauce-bar/' + escHtml(i[0]) + '.webp?v=' + SAUCE_IMG_V + '" alt="" draggable="false" onerror="this.remove()">'
          : '<img src="assets/sauce-bar/_직접입력.webp?v=' + SAUCE_IMG_V + '" alt="" draggable="false" onerror="this.remove()">');
      row.innerHTML = `
