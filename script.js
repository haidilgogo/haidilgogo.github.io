(() => {
  ...
  const GUIDE_BANNER = {
    ...
    body:
      ...
      // 여기서 뺐다 — 소스를 실제로 만드는 '02 소스바에서 소스 만들기'에서 쓰기로 함(사용자 지정).
      ...
      '<p>셀프소스바에는 땅콩참깨소스·스위트칠리소스 같은 베이스 소스부터 다진 마늘·고수 같은 향신료, 땅콩가루와 고추기름까지 다양한 재료가 놓여 있어요.</p>' +
      ...
      '<div class="col-tip">' +
        ...
        '<div class="col-tip-body">' +
          ...
          // 320px 실측 292px < 상자 340px으로 한 줄. 사용자 원안('처음인데다 소스 종류도 너무 많아
