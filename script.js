(() => {
  ...
  const RECIPES = [
    { id: 's1', date: '2021-12-26', cat: '소스', emoji: '🥣', img: 'assets/cards/건희소스(단)_2021.jpg?v=3', imgFit: 'cover', imgBg: '#A8CCDC', tint: 'linear-gradient(160deg,#FDECD9,#F8D9BE)', name: '건희소스', ver: '오리지널', source: '버블 건희', star: true, person: '건희', desc: '<b>원어스</b>의 <b>건희</b>가 즐겨 먹는 콤보 소스 중 단맛 버전으로, 대한민국에서 가장 유명한 국민 소스이다.',
    ...
    { id: 's16', date: '2021-12-26', cat: '소스', emoji: '🥣', img: 'assets/cards/건희소스(짠)_2021.jpg?v=4', imgFit: 'cover', imgBg: '#A8CCDC', tint: 'linear-gradient(160deg,#FDECD9,#F8D9BE)', name: '건희소스', ver: '짭짤', source: '버블 건희', star: true, person: '건희', desc: '<b>원어스</b>의 <b>건희</b>가 즐겨 먹는 콤보 소스 중 짠맛 버전으로, 단맛 버전과 번갈아 먹으면 질리지 않고 단짠단짠으로 즐길 수 있다고 한다.',
    ...
    { id: 's23', date: '2023-09-01', cat: '소스', emoji: '🥣', img: 'assets/cards/영지소스(악마).jpg?v=1', imgFit: 'cover', tint: 'linear-gradient(160deg,#F8D6CC,#EDA893)', name: '영지소스', ver: '악마', source: 'Instagram @youngji_02', star: true, person: '이영지', desc: '<b>이영지</b>가 인스타그램 스토리를 통해서 공개한 소스로, 매운 재료들만 넣어서 만들었기 때문에 마성의 악마소스라고 소개했다.',
    ...
    { id: 's27', date: '2025-03-27', cat: '소스', emoji: '🥣', img: 'assets/cards/건희소스_2025.jpg?v=1', imgFit: 'cover', tint: 'linear-gradient(160deg,#FDECD9,#F8D9BE)', name: '건희소스', ver: '2025', source: 'YouTube 다비드 봉', star: true, person: '건희', desc: '<b>원어스</b>의 <b>건희</b>가 단맛 버전을 리뉴얼해 공개한 소스로, <u>입맛이 바뀌어서 조금 달라졌다</u>라며 설탕을 빼는 등 기존 레시피에서 단맛을 많이 낮췄다.',
  ...
  const GUIDE_BANNER = {
    ...
    body:
      ...
      '<p>주문을 마쳤다면, 음식이 준비되는 동안 셀프소스바에 다녀와요.</p>' +
      ...
      // s1=건희소스(오리지널, 달달) / s2=쑨디2호소스(2022, 건더기 씹히는 짭짤).
